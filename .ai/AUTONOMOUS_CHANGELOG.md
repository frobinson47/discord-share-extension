...
- Commit hash: pending
- Follow-up notes: Not yet manually tested in a loaded browser. AUTO-003 may already be resolved — manifest.json only declares `"activeTab"`, not `"tabs"` — worth confirming before starting it.
